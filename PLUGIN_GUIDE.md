...
2. **Good Descriptions**: Write clear, specific, LLM-friendly descriptions that state what the tool does, when to use it ("Use this when …"), key constraints, and any defaults. The bot uses your descriptions as-is.
...
The LLM relies on your descriptions. For best results:
- Be explicit: what the tool does and when to use it ("Use this when …")
- Include constraints and important defaults (ranges, caps, required formats)
- Keep them concise (1–2 sentences) and unambiguous
- Use precise parameter descriptions; prefer enums where applicable
