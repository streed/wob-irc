...
2. **Tool Descriptions**: The bot uses your plugin, tool, and parameter descriptions as-is. Write clear, specific descriptions that state what the tool does, when to use it, and key constraints.
...
5. **AI Processing**: Messages are sent to Ollama with context and available tools (using your provided descriptions)
